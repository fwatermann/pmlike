        ...
        for(int y = 0; y < CHUNK_SIZE_Y; y++) {
            for(int z = 0; z < CHUNK_SIZE_Z; z++) {
                ...
                if(noise > blockCoords.y) {
                    chunk->blocks[x][y][z] = new block::Block(block::BlockMaterial::STONE, blockCoords, glm::ivec3(x, y, z));
                    continue;
                }
                chunk->blocks[x][y][z] = new block::Block(world::block::BlockMaterial::AIR, blockCoords, glm::ivec3(x, y, z));
            }
        }
    }
